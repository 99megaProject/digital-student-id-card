...
def merge_svg_template_back(data,SVG_TEMPLATE_PATH="other/id_card_back_template.svg",OUTPUT_PATH="../tmp/student_id_card_back.svg" ):
    ...
    qrcode_uri = get_image_base64("https://res.cloudinary.com/dr9w7oyqe/image/upload/v1761991708/qr-code-json-removebg-preview_eygzba.png", placeholder_text="QRcode")
